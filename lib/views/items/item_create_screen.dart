        ...
        body: BlocBuilder(
          ...
          builder: (context,state){
            ...
            return BottomButton(
              ...
              btnText: "save",
              onPressed: (){
                viewModel.createItem(context,bloc);
              },
            );
          },
        ),
          ...
          child: Column(
            ...
            children: [
              Box(
                ...
                bgColor: white,
                child: TagsRadio(
                  tags: const ["Prices With Tax","Prices Without Tax"],
                  selected: (val) {
                    viewModel.isPriceWithTax = val=="Prices With Tax";
                  },
                ),
              ),
              ExpandedRow(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      TextInput(
                        ...
                        radius: blunt,
                        textHeight: 1.5,
                        controller: viewModel.hsnController,
                        bgColor: white,
                        enabledBorderColor: borderColor,
                        focusedBorderColor: borderColor,
                        contentPadding: const [12,12],
    ...
    return Column(
      ...
      children: [
            ...
            Column(
              ...
              children: [
                ...
                TextInput(
                  ...
                  textHeight: 1.5,
                  bgColor: white,
                  controller: viewModel.openingStockController,
                  enabledBorderColor: borderColor,
                  focusedBorderColor: borderColor,
                  contentPadding: const [12,12],
                  labelColor: promptColor,
                ...
                InkWell(
                  ...
                  onTap: () async{
                    ...
                    if(date!= null) {
                      ...
                      viewModel.asOfDate = selectedDate!;
                      setState(() {});
                    }
                  },
                )
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextInput(
                      ...
                      radius: blunt,
                      textHeight: 1.5,
                      controller: viewModel.lowStockQuantityController,
                      suffixText: const Box(width: 30,bgColor: borderColor,),
                      bgColor: white,
                      enabledBorderColor: borderColor,
                      focusedBorderColor: borderColor,
                      contentPadding: const [12,12],
        ...
        TextInput(
          ...
          textHeight: 1.5,
          bgColor: white,
          controller: viewModel.itemCodeController,
          enabledBorderColor: borderColor,
          focusedBorderColor: borderColor,
          contentPadding: const [12,12],
          labelColor: promptColor,
    ...
    return Column(
      ...
      children: [
        ...
        TextInput(
          ...
          textHeight: 1.5,
          bgColor: white,
          controller: viewModel.mrpController,
          enabledBorderColor: borderColor,
          focusedBorderColor: borderColor,
          contentPadding: const [12,12],
          labelColor: promptColor,
            ...
            Column(
              ...
              children: [
                ...
                TextInput(
                  ...
                  focusedBorderColor: borderColor,
                  contentPadding: const [12],
                  controller: viewModel.minWholeSaleQuantityController,
                  labelColor: promptColor,
                  suffixText: Label(
                    label: viewModel.selectedUnit,
                    mainAxisAlignment: mainStart,
